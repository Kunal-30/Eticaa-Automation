...
/**
 * Role filter Excel util.
 *
 * Template path: src/test/resources/filters_professional_details/role_filter.xlsx
 * Sheet name   : RoleFilters
 * Column       : Role
 */
public class role_filter_Util {

    public static final String SHEET_NAME = "RoleFilters";
    ...
    public static void createTemplateIfMissing(String excelPath) {
        try {
            ...
            if (Files.exists(path)) {
                System.out.println("[ROLE FILTER] Excel already exists: " + excelPath);
                return;
            }
    ...
    public static List<String> readRoles(InputStream in) {
        ...
        try (Workbook wb = WorkbookFactory.create(in)) {
            ...
            System.err.println("[ROLE FILTER] Failed to read: " + e.getMessage());
        }
        return result;
    }
    ...
    public static List<String> getRandomRoles(List<String> all, int count) {
