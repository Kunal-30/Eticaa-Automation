...
/**
 * Advanced Filter – Current CTC ranges from CTCMaster.xlsx.
 *
 * Logic is copied from superadmintest.advancedFilter_FromExcel_AssertAndMarkCandidates_for_CurrentCTC_Filter
 * without functional changes, only relocated into its own test class.
 */
@Feature("Advanced Filters - Current CTC")
public class CurrentCtcFilterTest extends basePage {
    ...
    private void printCurrentCTCFilterSummaryTable(int min,
        ...
        System.out.println("----------------------------------------------------------------------");
        System.out.println("Filter Type      : Current CTC");
    ...
    public void setUpSshTunnel() {
        System.out.println("\n[FRAMEWORK] =========================================");
        System.out.println("[FRAMEWORK] BeforeClass (CurrentCtcFilter): Starting SSH tunnel for DB access");
    ...
    public void tearDownSshTunnel() {
        System.out.println("\n[FRAMEWORK] =========================================");
        System.out.println("[FRAMEWORK] AfterClass (CurrentCtcFilter): Stopping SSH tunnel");
        System.out.println("[FRAMEWORK] =========================================");
